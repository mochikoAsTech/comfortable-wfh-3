...
ポイントとスペックがあっているか要確認。ハーマンミラーは年に2回くらい15%オフや25%オフのセールをするので、買うならそのタイミングがお勧め。（@<img>{cosm}）

//image[cosm][フレームがキャニオン、SteelcaseのEdviカタログから引用][scale=1]{
//}
