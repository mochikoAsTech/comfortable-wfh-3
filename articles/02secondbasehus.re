...
ちなみに書斎ではないのだが、飲み物つながりで紹介しておきたいアイテムがある。キッチンに置いた、ドリンクメイトという液体をなんでも炭酸飲料にできるマシンだ！ドリンクメイトでアイスティーを炭酸にして、イオントップバリュの「割るだけオレンジ@<fn>{eaon}」というオレンジの希釈液を混ぜるとオレンジティーソーダ@<fn>{orange}が完成する。

//footnote[eaon][@<href>{https://www.topvalu.net/items/detail/4549414627763/}]
